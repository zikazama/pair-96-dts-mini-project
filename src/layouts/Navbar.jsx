...
function Navbar() {
  return (
    <>
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-first-dark">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex">
            <Logo
              srcParse="https://gcdnb.pbrd.co/images/hKRBpE0nOOTV.png?o=1"
              styleParse="w-[36px] h-[44px]"
            />
          </Link>
          {/* <button
